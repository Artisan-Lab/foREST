...
def fuzz(param_pool, success_pool, fuzz_pool, username, password, optional, matr, tag, api_info, cov_url, Authorization, operation_mode, restart, op_length):
    ...
    if not optional:
        ...
        fuzz_success_data = get_success_case().get_fuzz_success(success_pool, tag, method)
    ...
    if not optional:
                ...
                try:
                    ...
                    if ini_coverage_rate_executed_code == 1000:
                        ...
                        if now_coverage_rate_executed_code != ini_coverage_rate_executed_code:
                            ...
                            save_success_case().save_fuzz_success(success_pool, tag, fuzz_success_json_data, method)
                except ValueError:
                    print("NOT JSON")
            else:
                pass
        ...
        for fuzz_case in fuzz_cases:
            if len(eval(fuzz_case)) == op_length:
                ...
                try:
                    ...
                    if ini_coverage_rate_executed_code == 1000:
                        ...
                        if now_coverage_rate_executed_code != ini_coverage_rate_executed_code:
                            ...
                            fuzz_success_json_data = json.dumps(fuzz_case)
                            save_success_case().save_fuzz_optional_success(success_pool, tag, fuzz_success_json_data, method)
                except ValueError:
                    print("NOT JSON")
            else:
                pass
