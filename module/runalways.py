from module.test import traversal,fuzzgraph
from module.graph2 import get_dep_info
from module.parse import get_api_info
import os.path
from multiprocessing import Queue,Process
from module.Fuzz_monitor import Fuzz_monitor
...
def run(cov_url):
    while(1 == 1):
        ...
        print(matrix)
        graph = matrix.tolist()
        visited = traversal(graph, api_info_list, cov_url)
        api = api_info_list
        # 未测试的单独fuzz
        print(visited)
